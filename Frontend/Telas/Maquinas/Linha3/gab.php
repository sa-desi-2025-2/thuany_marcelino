...
$id_maquina = 59;
$nome_maquina = "Linha 3 - Injetora de Gabinetes (seca)";
...
<head>
    ...
    <style>
        ...
        .ewo-list-container {
            max-height: 650px;
            /* Limita altura da tabela */
            overflow-y: auto;
            /* Adiciona a barra de rolagem vertical se o conteúdo exceder a altura limitada */
            padding-right: 15px;
            /* Adiciona padding para a barra de rolagem não encostar nas bordas */
        }
    </style>
</head>

<body
    style="height: 100vh; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; display: flex; flex-direction: column;">
    ...
    <div class="maquina-header-bar" style="background-color: #0b3553; color: white; padding: 15px 20px;">
            ...
            <div class="row justify-content-center mt-5">
                <div class="col-md-6">
                    <div class="card p-4 border border-danger text-center" style="color: red;">
                        ...
                        <button onclick="window.history.back();" class="btn btn-danger mt-3"
                            style="width: 100px; margin: 0 auto;">OK</button>
                    </div>
                </div>
            </div>
